...
| GLM-5.3-Flash EXL3 2BPW | `0xSero/GLM-5.3-Flash-EXL3-2BPW` | Claimed 128 GiB class; EXL3 is unreliable on Turing | **Previously tested model** | GLM-5.3-Flash was measured with a 147.54 GB Q3 GGUF; see `targets/glm-5.3-flash/PERFORMANCE.md` |
...
All four eligible candidates completed successfully. Models marked previously
tested, unavailable, or over the 192 GiB aggregate VRAM limit were not run.
